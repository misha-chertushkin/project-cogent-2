...
# from google.adk.tools import VertexAiSearchTool #This built in tool can be used if the region is set to global 
...
#This built in tool can be used if the region is set to global 
